...
| MCP | `examples/codex/.codex/config.toml.example` now; issue #9 validates the server | `examples/claude/.mcp.json.example` now; issue #9 validates the server | `examples/cursor/.cursor/mcp.json.example` |
