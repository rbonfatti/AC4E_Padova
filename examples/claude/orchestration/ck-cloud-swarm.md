...
| --- | --- | --- | --- |
| 1 | Data documentation and panel validation | `ck/data-validation` | `data-reviewer` |
| 1 | Literature/source note | `ck/source-note` | `literature-reviewer` |
| 2 | Estimation or robustness implementation | `ck/robustness` | `replication-verifier` |
| 3 | Teaching figure | `ck/teaching-figure` | `pr-reviewer` |
